...
void	recup_argument2(t_f **cr, int j, int i)
{
...
void	recup_argument(t_f **cr)
{
	...
	i = 1;
	j = 0;
	length = ft_strlen_secure((*cr)->flag) +
		ft_strlen_secure((*cr)->width) +
		ft_strlen_secure((*cr)->precision) +
		ft_strlen_secure((*cr)->modifier) +
